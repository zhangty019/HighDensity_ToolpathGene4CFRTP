...
namespace DDG
{
   ...
   class DenseMatrix
   {
      public:
         ...
         const DenseMatrix<T>& operator=(Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> B);
         ...
         Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> to_Eigen( void );
   ...
   Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>
       fromRealDenseMatrix(DenseMatrix<T>& A);

   template <class T>
   Eigen::Matrix<std::complex<double>, Eigen::Dynamic, Eigen::Dynamic>
       fromComplexDenseMatrix(DenseMatrix<T>& A);

   template <class T>
   Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>
       fromQuaternionDenseMatrix(DenseMatrix<T>& A);
