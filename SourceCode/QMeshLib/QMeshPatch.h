...
public:
	...
	bool inputStripOBJFile(char* filename);
   ...
   //for volume mesh
	...
	// for stripPathGeneration
	bool drawThisPatch = true;
	std::string patchName = "";
	bool isStressLayer = false;
	int constraintNumber = 0;
	bool draw_directionField_onFace = false;
	bool draw_Field_onFace = true;
	bool draw_stripPattern = false;
